...
$HADOOP_HOME/bin/hadoop jar $HADOOP_HOME/contrib/hadoop-streaming.jar -mapper $HADOOP_HOME/demos/mapper.py -reducer $HADOOP_HOME/demos/reducer.py -input demoinputs -output demooutputs
